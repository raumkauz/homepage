...
<p>{{% paige/image alt="Banner" breakpoints=true link="/portfolio/" class="object-fit-cover rounded-4" fetchpriority="width" height="20rem" loading="eager" process="webp" src="img/banner_cropped.jpg" width="100%" %}} </p>
